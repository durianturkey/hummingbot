...
class CoinstoreAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = CoinstoreAPIOrderBookDataSource(
        ...
        self.connector._set_symbolId_map(bidict({self.ex_trading_pair: self.instrument_id}))
    ...
    def _trade_update_event(self):
        resp = {
            ...
            "data": [
                {
                    "channel": str(self.instrument_id) + "@trade",
                    "time": 1695019427,
                    "price": "26651.07",
                    "tradeId": 12345,
                    "volume": "0.003851",
    ...
    def _snapshot_response(self):
        resp = {
            "data": {
                "channel": str(self.instrument_id) + "@depth@5",
                "level": 5,
                "a": [["4.00000200", "12.00000000", -1]],
                "b": [["4.00000000", "431.00000000", 1]],
                "symbol": self.ex_trading_pair,
                "instrumentId": 4,
            },
            "code": 0,
    ...
    def test_get_new_order_book_successful(self, mock_api):
        ...
        expected_update_id = int(time.time())
    ...
    def test_listen_for_subscriptions_subscribes_to_trades_and_order_diffs(self, ws_connect_mock):
        ...
        expected_trade_subscription = {
            "op": "SUB",
            "channel": [f"{self.instrument_id}@trade"],
            "param": {"size": 2},
            "id": 1,
        }
        ...
        expected_diff_subscription = {
            "op": "SUB",
            "channel": [f"{self.instrument_id}@depth@100"],
            "id": 2,
        }
    ...
    def test_listen_for_order_book_diffs_successful(self):
        ...
        self.assertEqual(diff_event["trading_pair"], msg.trading_pair)
    ...
    @aioresponses()
    @patch(
        "hummingbot.connector.exchange.coinstore.coinstore_api_order_book_data_source"
        ".CoinstoreAPIOrderBookDataSource._sleep"
    )
    ...
    def test_listen_for_order_book_snapshots_successful(
        ...
        self.assertEqual(int(time.time()), msg.update_id)
